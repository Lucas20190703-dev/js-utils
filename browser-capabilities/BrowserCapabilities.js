...
// TODO: Move BrowserCapabilities from lib-qhsense-meet here and use the JSON
// format for them.
...
export default class BrowserCapabilities {
     ...
     * @param {boolean} [isUsingIFrame] - True if qhsense Meet is loaded in iframe
     * and false otherwise.
    ...
    /**
     * Checks whether the browser is supported by qhsense Meet.
     *
     * @returns {boolean}
     */
    isSupported() {
